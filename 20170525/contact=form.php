    ...
    <form action = "contact=form=comfirm.php" method ="post"> <!--postの送信先-->
        ...
        <table>
            ...
            <tr>
                <td>※性別</td>
                <td>
                    <input required type = "radio" name = "Gender" id = "Man" value = "男" /><label for = "Man">男</label> <!--labelはテキストをクリックして選択できるようする-->
                    <input required type = "radio" name = "Gender" id = "Woman" value = "女" /><label for = "Woman">女</label>
                    <input required type = "radio" name = "Gender" id = "Unknown" value = "不明" /><label for = "Unknown">不明</label>
                </td>
            </tr>
            <tr>
                <td>住所</td>
            ...
            <tr>
                <td>どこで知ったか</td>
                <td>
                    <input type = "checkbox" name = "How_Known[]" id = "Magazine" value = "雑誌" /><label for = "Magazine">雑誌</label> <!--nameをxxxx[]にすることで配列に入力値を入れることができる-->
            ...
            <tr>
                ...
                <td>
                    <select name = "QCtgry">
                        <option value = "" selected = "selected" /></option> <!--何も書かれていないリストを追加-->
